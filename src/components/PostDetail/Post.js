      ...
      <Grid width="50vw" margin="50px auto 20px">
        ...
        <Grid is_flex>
          ...
          <Grid height="350px" border margin="0px 0px 0px 20px" padding="10px 15px" overflow >
            <Text margin="0 0 15px 0px" size="16px" bold right>작성자 : {userId} </Text>
            <Text margin="10px 0 20px 0px" bold>가수이름 : {singer} </Text>
            <Text margin="10px 0 20px 0px" bold>곡 이름: {songName} </Text>
            <Text margin="0 0 20px 0px" bold>곡 설명 : {desc} </Text>
            <Text margin="0 0 20px 0px" bold> 유튜브 링크 : {url} </Text>
            <Text margin="0 0 20px 0px" bold>#{category1} #{category2} #{category3}</Text>
